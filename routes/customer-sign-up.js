...
router.post('/signup-rhemi', async (req, res) => {
   ...
   try {
      const session = await stripe.checkout.sessions.create({
         ...
         success_url: 'https://www.rhemi.io/signup-stripe', 
         cancel_url: 'https://www.rhemi.io/pricing',
      });
      res.send({
...
router.post('/signup-user-stripe-acct', async (req, res) => {
   try {
      ...
      const accountLink = await stripe.accountLinks.create({
         account: account.id,
         refresh_url: 'https://www.rhemi.io/signup-stripe', // give refresh url if user doesn't complete
         return_url: 'https://www.rhemi.io/thank-you', // return url when finished
